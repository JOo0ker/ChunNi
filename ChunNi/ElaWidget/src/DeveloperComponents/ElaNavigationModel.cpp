...
void ElaNavigationModel::setSelectedNode(ElaNavigationNode* SelectedNode)
{
	Q_D(ElaNavigationModel);
	d->_pSelectedNode = SelectedNode;
	Q_EMIT pSelectedNodeChanged();
}

ElaNavigationNode* ElaNavigationModel::getSelectedNode() const { return d_ptr->_pSelectedNode; }
void ElaNavigationModel::setSelectedExpandedNode(ElaNavigationNode* SelectedExpandedNode)
{
	Q_D(ElaNavigationModel);
	d->_pSelectedExpandedNode = SelectedExpandedNode;
	Q_EMIT pSelectedExpandedNodeChanged();
}

ElaNavigationNode* ElaNavigationModel::getSelectedExpandedNode() const { return d_ptr->_pSelectedExpandedNode; }
