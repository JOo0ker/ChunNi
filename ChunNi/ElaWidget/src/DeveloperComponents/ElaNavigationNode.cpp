...
void ElaNavigationNode::setParentNode(ElaNavigationNode* ParentNode)
{
	Q_D(ElaNavigationNode);
	d->_pParentNode = ParentNode;
	Q_EMIT pParentNodeChanged();
}

ElaNavigationNode* ElaNavigationNode::getParentNode() const { return d_ptr->_pParentNode; }
