...
void ElaNavigationDelegate::setNavigationView(ElaNavigationView* NavigationView)
{
	Q_D(ElaNavigationDelegate);
	d->_pNavigationView = NavigationView;
	Q_EMIT pNavigationViewChanged();
}

ElaNavigationView* ElaNavigationDelegate::getNavigationView() const { return d_ptr->_pNavigationView; };
