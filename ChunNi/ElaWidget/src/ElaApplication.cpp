...
void ElaApplication::setWindowIcon(QIcon WindowIcon)
{
	Q_D(ElaApplication);
	d->_pWindowIcon = WindowIcon;
	Q_EMIT pWindowIconChanged();
}

QIcon ElaApplication::getWindowIcon() const { return d_ptr->_pWindowIcon; }
